...
\begin{document}
\titleheader{\section*{CS170 SP2019 Quiz 2 Solution}}{\section*{CS170 SP2019 Quiz 2}}

This is a close book, close note quiz. Total points are 10. You have 10 minutes. Don't forget to put your name on the quiz. 
...
\item What are the absolute path and relative path for the textfile(in circle) in the following diagram giving the current working directory is \texttt{mike} [2]? 
\begin{center}
\includegraphics[width=0.45\textwidth]{FilesysExample1}
\end{center}
\vspace{1in}
