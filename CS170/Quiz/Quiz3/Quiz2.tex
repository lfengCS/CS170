...
\begin{document}
\titleheader{\section*{CS170 SP2020 Quiz 3 Solution}}{\section*{CS170 SP2020 Quiz 3}}

This is a close book, close note quiz. Total points are 10. You have 10 minutes. Don't forget to put your name on the quiz. 

\begin{enumerate}

\item Briefly answer the following questions: [2]
\begin{enumerate}
...
What are the results after executing the following commands? [3]
\begin{enumerate}
%\item \texttt{ls sec*}
%\vspace{0.5in}
\item \texttt{ls ref?} 
\vspace{0.5in}
\item \texttt{ls section[1-4]}  
\vspace{0.5in}
\item \texttt{ls i*}
\vspace{0.5in}
%\item \texttt{ls *[13]} 
